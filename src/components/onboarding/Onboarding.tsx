              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none"
                  />
                </div>
                <div className="space-y-1">
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{ width: '100%', minWidth: 0 }}
                      className="px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none"
                    />
                  </div>
                  <div>
